 ...
 * 友盟社会化分享授权登录示例
 */
public class UmengAuthActivity extends BaseActivity{
        ...
        public void onClickAuth(View view) {
            ...
            mShareAPI.doOauthVerify(UmengAuthActivity.this, platform, umAuthListener);
        }
    ...
    public void onClickDeletAuth(View view) {
        ...
        /**begin invoke umeng api**/
        mShareAPI.deleteOauth(UmengAuthActivity.this, platform, umdelAuthListener);
    }
