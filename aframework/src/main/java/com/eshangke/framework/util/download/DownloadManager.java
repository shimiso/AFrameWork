package com.eshangke.framework.util.download;
...
public final class DownloadManager {
    ...
    public List getLoadingList() {
        List loadingData = new ArrayList();
        for (DownloadInfo info : downloadInfoList) {

            if (info.getState().value() != DownloadState.FINISHED.value()) {
                loadingData.add(info);
            }
        }
        LogUtil.e("getLoadingList = " + loadingData.toString());
        return loadingData;
    }
    ...
    public List getLoadedList() {
        ...
        LogUtil.e("getLoadedList = " + loadedData.toString());
        return loadedData;
    }
     ...
     * @throws DbException
     */
    public void removeBatchDownload(List<DownloadInfo> infoList) throws DbException {
