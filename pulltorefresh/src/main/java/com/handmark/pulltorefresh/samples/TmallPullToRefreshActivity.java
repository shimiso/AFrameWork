...
import com.handmark.pulltorefresh.samples.loadinglayout.TmallFooterLayout;
import com.handmark.pulltorefresh.samples.loadinglayout.TmallHeaderLayout;
 ...
 */
public class TmallPullToRefreshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ptr_tmall);

        mListItems = new LinkedList<>();
        mListItems.add(R.drawable.tm_recycler0);
        mListItems.add(R.drawable.tm_recycler2);
        mListItems.add(R.drawable.tm_recycler4);
...
//        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        loopViewImage.setBackgroundResource(R.drawable.tm_picture0);
        ...
        functionImage.setBackgroundResource(R.drawable.tm_picture1);
    ...
    private class GetDataTask extends AsyncTask<String, Void, Integer[]> {
        ...
        protected Integer[] doInBackground(String... params) {
            ...
            if(params[0].equals("下拉刷新")) {
                ...
                Integer[] a1 = {R.drawable.tm_recycler1, R.drawable.tm_recycler3, R.drawable.tm_recycler5};
                return a1;
            }
        }
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                    TmallPullToRefreshActivity.this).inflate(R.layout.layout_recycler_item, parent,
                    false));
            return holder;
        }
