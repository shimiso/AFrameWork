...
public class PullToRefreshLauncherActivity extends ListActivity {
	...
	public static final String[] options = { "ListView", "ExpandableListView", "GridView", "WebView", "ScrollView",
			...
			"RecyclerView","天猫RecyclerView","美团ScrollView","汽车之家RecyclerView"};
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position) {
			...
			case 10:
				...
				break;
			case 11:
				intent = new Intent(this, TmallPullToRefreshActivity.class);
				break;
			case 12:
				intent = new Intent(this, MeiTuanPullToRefreshActivity.class);
				break;
			case 13:
				intent = new Intent(this, CarHomePullToRefreshActivity.class);
				break;
		}
